...
export class PriceOracleERC20__strategiesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceOracleERC20 extends ethereum.SmartContract {
  static bind(address: Address): PriceOracleERC20 {
    return new PriceOracleERC20("PriceOracleERC20", address);
  }
  ...
  strategies(arg0: Address): PriceOracleERC20__strategiesResult {
    let result = super.call(
      "strategies",
    ...
    return new PriceOracleERC20__strategiesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_strategies(
    arg0: Address
  ): ethereum.CallResult<PriceOracleERC20__strategiesResult> {
    let result = super.tryCall(
      "strategies",
      "strategies(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(arg0)]
    ...
    return ethereum.CallResult.fromValue(
      new PriceOracleERC20__strategiesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
