...
export class LendingPoolRegistry extends ethereum.SmartContract {
  static bind(address: Address): LendingPoolRegistry {
    return new LendingPoolRegistry("LendingPoolRegistry", address);
  }
