...
export class MarketPlace_Card__nftMapResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class MarketPlace_Card__nftMapV2Result {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class MarketPlace_Card extends ethereum.SmartContract {
  static bind(address: Address): MarketPlace_Card {
    return new MarketPlace_Card("MarketPlace_Card", address);
  }
  ...
  nftMap(param0: BigInt): MarketPlace_Card__nftMapResult {
    ...
    return new MarketPlace_Card__nftMapResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_nftMap(
    param0: BigInt
  ): ethereum.CallResult<MarketPlace_Card__nftMapResult> {
    let result = super.tryCall(
      "nftMap",
      "nftMap(uint256):(uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new MarketPlace_Card__nftMapResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt()
  ...
  nftMapV2(param0: BigInt): MarketPlace_Card__nftMapV2Result {
    let result = super.call(
      "nftMapV2",
    ...
    return new MarketPlace_Card__nftMapV2Result(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_nftMapV2(
    param0: BigInt
  ): ethereum.CallResult<MarketPlace_Card__nftMapV2Result> {
    let result = super.tryCall(
      "nftMapV2",
      "nftMapV2(uint256):(uint256,uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MarketPlace_Card__nftMapV2Result(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress(),
