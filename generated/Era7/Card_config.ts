...
export class Card_config__nftMapResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class Card_config__nftMapV2Result {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class Card_config extends ethereum.SmartContract {
  static bind(address: Address): Card_config {
    return new Card_config("Card_config", address);
  }
  ...
  nftMap(param0: BigInt): Card_config__nftMapResult {
    ...
    return new Card_config__nftMapResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_nftMap(param0: BigInt): ethereum.CallResult<Card_config__nftMapResult> {
    let result = super.tryCall(
      "nftMap",
      "nftMap(uint256):(uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  nftMapV2(param0: BigInt): Card_config__nftMapV2Result {
    let result = super.call(
      "nftMapV2",
    ...
    return new Card_config__nftMapV2Result(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_nftMapV2(
    param0: BigInt
  ): ethereum.CallResult<Card_config__nftMapV2Result> {
    let result = super.tryCall(
      "nftMapV2",
      "nftMapV2(uint256):(uint256,uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Card_config__nftMapV2Result(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress(),
