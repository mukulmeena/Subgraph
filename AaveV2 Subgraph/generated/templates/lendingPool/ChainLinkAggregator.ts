...
export class ChainLinkAggregator__proposedGetRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainLinkAggregator__proposedLatestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainLinkAggregator extends ethereum.SmartContract {
  ...
  proposedGetRoundData(
    _roundId: BigInt
  ): ChainLinkAggregator__proposedGetRoundDataResult {
    let result = super.call(
      "proposedGetRoundData",
    ...
    return new ChainLinkAggregator__proposedGetRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<ChainLinkAggregator__proposedGetRoundDataResult> {
    let result = super.tryCall(
      "proposedGetRoundData",
      "proposedGetRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainLinkAggregator__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedLatestRoundData(): ChainLinkAggregator__proposedLatestRoundDataResult {
    let result = super.call(
    ...
    return new ChainLinkAggregator__proposedLatestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedLatestRoundData(): ethereum.CallResult<
    ChainLinkAggregator__proposedLatestRoundDataResult
  > {
    let result = super.tryCall(
      "proposedLatestRoundData",
      "proposedLatestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainLinkAggregator__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
