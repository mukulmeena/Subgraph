...
import { UniswapPair__getReservesResult } from "../../../generated/Era7/UniswapPair";
import { SushiSwapPair__getReservesResult } from "../../../generated/Era7/SushiSwapPair";
...
USDC_DECIMALS_MAP.set(MAINNET.NETWORK_STRING, MAINNET.USDC_DECIMALS as i32);
USDC_DECIMALS_MAP.set(BSC.NETWORK_STRING, BSC.USDC_DECIMALS as i32);
USDC_DECIMALS_MAP.set(FANTOM.NETWORK_STRING, FANTOM.USDC_DECIMALS as i32);
USDC_DECIMALS_MAP.set(ARBITRUM_ONE.NETWORK_STRING, ARBITRUM_ONE.USDC_DECIMALS as i32);
